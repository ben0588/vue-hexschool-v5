<template>
  <h2>購物車列表</h2>
  <div v-if="cartsStore.carts.length">
    <button type="button" @click="deleteAllCarts" class="btn btn-danger">刪除全部商品</button>
...
const { getCarts, deleteCart, deleteAllCarts, changeCartQty, checkIsLoadingState, total } =
  cartsStore;
onMounted(() => {
  getCarts();
});
